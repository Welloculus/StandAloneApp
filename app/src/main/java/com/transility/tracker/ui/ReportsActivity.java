...
import com.transility.tracker.beans.HealthDataBean;
import com.transility.tracker.beans.HealthRecordBean;
import com.transility.tracker.db.DBHelper;
import com.transility.tracker.utils.CalendarDialog;
...
public class ReportsActivity extends BaseActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener, CalendarDialog.OnDateSetListener {
    ...
    private void insertDummyValues() {
        for (int i=0;i<50;i++){
            try {
                ...
                DBHelper dbHelper = DBHelper.getInstance(mContext);
                dbHelper.insertHealthData("1021", "Fora BP monitor", mDateBtnFormat.parse("10/08/2017").getTime(), Constants.DATA_TYPE_BLOOD_PRESSURE, dataObject.toString());
            }catch (Exception e){
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.transility.tracker/http/host/path")
        );
