...
import com.transility.tracker.fora.interfaces.CustomAlertOnClickListener;
import com.transility.tracker.fora.preference.MeterPreferenceDialog;
...
public class PCLinkLibraryDemoActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.activity_fora_menu, menu);
        return true;
    }
